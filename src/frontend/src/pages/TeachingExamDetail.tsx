...
const examNames: Record<string, string> = {
  ...
  uptet: 'UPTET - Uttar Pradesh TET',
  htet: 'HTET - Haryana TET',
  reet: 'REET - Rajasthan Eligibility Exam for Teachers',
  mptet: 'MPTET - Madhya Pradesh TET',
  superTET: 'Super TET - Uttar Pradesh',
  ...
  stateTET: 'State TET - Various State TET Exams',
};

export default function TeachingExamDetail() {
  ...
  const examName = examNames[examType || ''] || 'Teaching Exam';
        ...
        {isLoading ? (
          ...
          <Tabs defaultValue="syllabus" className="space-y-6">
            <TabsList className="grid w-full grid-cols-4">
              ...
              <TabsTrigger value="paper-pattern">Paper Pattern</TabsTrigger>
            </TabsList>
            ...
            {courses.map((course) => (
              <div key={course.id.toString()}>
                ...
                <TabsContent value="paper-pattern">
                  <Card>
                    <CardHeader>
                      <CardTitle>Exam Pattern & Eligibility</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <Alert>
                        <AlertDescription>
                          Exam pattern and eligibility criteria will be added soon.
                        </AlertDescription>
                      </Alert>
                    </CardContent>
                  </Card>
