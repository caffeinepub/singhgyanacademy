...
import { Train, FileText, ClipboardList } from 'lucide-react';
...
const examNames: Record<string, string> = {
  rrbNTPC: 'RRB NTPC - Non-Technical Popular Categories',
  rrbGroupD: 'RRB Group D',
  rrbALP: 'RRB ALP - Assistant Loco Pilot',
  rrbTechnician: 'RRB Technician',
  rrbJE: 'RRB JE - Junior Engineer',
  rpfConstable: 'RPF Constable',
  rpfSI: 'RPF SI - Sub-Inspector',
};

export default function RailwayExamDetail() {
  ...
  const examName = examNames[examType || ''] || 'Railway Exam';
