...
const examNames: Record<string, string> = {
  ibpsPO: 'IBPS PO - Probationary Officer',
  ibpsClerk: 'IBPS Clerk',
  sbiPO: 'SBI PO - State Bank of India',
  sbiClerk: 'SBI Clerk',
  rbiGradeB: 'RBI Grade B - Reserve Bank of India',
  nabard: 'NABARD - National Bank for Agriculture',
  licAAO: 'LIC AAO - Assistant Administrative Officer',
};

export default function BankingExamDetail() {
  ...
  const examName = examNames[examType || ''] || 'Banking Exam';
