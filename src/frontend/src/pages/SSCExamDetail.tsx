...
const examNames: Record<string, string> = {
  sscCGL: 'SSC CGL - Combined Graduate Level',
  sscCHSL: 'SSC CHSL - Combined Higher Secondary Level',
  sscGD: 'SSC GD - General Duty Constable',
  sscMTS: 'SSC MTS - Multi-Tasking Staff',
  sscCPO: 'SSC CPO - Central Police Organization',
  sscStenographer: 'SSC Stenographer',
  sscJE: 'SSC JE - Junior Engineer',
  sscSelectionPost: 'SSC Selection Post',
  sscConstable: 'SSC Constable',
};

export default function SSCExamDetail() {
  ...
  const examName = examNames[examType || ''] || 'SSC Exam';
                  ...
                  <Card>
                    ...
                    <CardContent>
                      {course.pyq.length > 0 ? (
                          ...
                          {course.pyq.map((paper, index) => (
                            <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                              <div className="flex items-center gap-3">
                                ...
                                <span>Previous Year Paper {index + 1}</span>
                              </div>
                              <a
                        ...
                        <Alert>
                          <AlertDescription>Previous year papers will be added soon.</AlertDescription>
                        </Alert>
                      )}
                    </CardContent>
                  </Card>
