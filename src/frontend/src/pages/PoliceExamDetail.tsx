...
const examNames: Record<string, string> = {
  ...
  rajasthanPolice: 'Rajasthan Police',
  haryanaPolice: 'Haryana Police',
  capf: 'CAPF - Central Armed Police Forces',
  otherStatesPolice: 'Other State Police',
};

export default function PoliceExamDetail() {
  ...
  const examName = examNames[examType || ''] || 'Police Exam';
